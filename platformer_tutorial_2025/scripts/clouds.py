...
class Cloud:
    def __init__(self, pos, img, speed, depth):
        ...
        self.img = img
        self.speed = speed
        self.depth = depth # Must be < 1

    def update(self):
        # A cloud just needs to move sideways
        self.pos[0] += self.speed

    def render(self, surf, offset=(0, 0)):
        render_pos = (self.pos[0] - offset[0] * self.depth, self.pos[1] - offset[1] * self.depth) # Depth multiplier creates parallax affect by forcing clouds to move slower.
